...
[_LOWER] = LAYOUT_plaid_grid(
    ...
    KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     KC_UNDS,    KC_MINS, KC_LCBR, KC_RCBR, KC_PIPE,
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  S(KC_NUHS), S(KC_NUBS), KC_LBRC, KC_RBRC, _______,
...
[_RAISE] = LAYOUT_plaid_grid(
    ...
    _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_EQL, KC_PLUS,  XXXXXXX, XXXXXXX, KC_BSLS,
    _______,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, XXXXXXX, KC_AMPR, _______,
